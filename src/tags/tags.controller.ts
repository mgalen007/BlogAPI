import { Controller, Get, Post, Put, Delete, Query, Param, ParseIntPipe, Body, ValidationPipe, HttpCode, HttpStatus } from '@nestjs/common';
...
export class TagsController {
    ...
    @Put(':id')
    async update(@Body(ValidationPipe) body: UpdateTagDto, @Param('id') id: string) {
